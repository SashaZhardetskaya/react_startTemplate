...
class Video extends Component {
    ...
    handleMainResumeBtn = () => {
        ...
        setTimeout(() => {
            scrollToComponent(this.VideoDescriptionAccardion, { offset: 0, align: 'top', duration: 650, ease:'inExpo'});
        }, 400);

        const videoGalleryCurrentItemIndex = () => (
            this.props.videoGallery.map((item, index) => {
    ...
    renderMainVideoDescription = () => (
        <div className="sm-bottom20 wow fadeIn">
            <div className="videoDescWrapper main-video-preview-wrapper">
                <div className="videoDesc main-video-preview">
                    {/*<img src={BackgroundImage} alt=""/>*/}
                    <img src='http://webworldpk.com/demo/99point9/assets/videos/5.jpg' alt=""/>
                    <div className="row video-main-preview-resume">
                        <div className="sm-top-bottom40  wow bounceInUp"
                            ...
                            <button
                                className="btn btn-danger btn-block"
                                onClick={this.handleMainResumeBtn}
                            >
                                <i className="zmdi zmdi-play"/>
                                Resume
                            </button>
    ...
    renderVideos = () => {
        return this.props.videoGallery.map((item, index) => {
            // console.log('this.state.el', this.state.el);
            return (
                <div
                    ...
                    + (item.isShow
                        ...
                        : ''+ (item.isActive
                            ? (!item.isComplete &&
                                    (this.state.show
                                        ? (this.state.el === index)
                                                ? ' videoDescTriangle active-video-wrapper'
